 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripCostCenterEntityAddResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3695494546742583852L;
	...
	public static class OpenCostCenterAddEntityRs extends TaobaoObject {
		private static final long serialVersionUID = 4784411871548617899L;
		/**
		 * 增加的人员信息条数
		 */
		@ApiField("add_num")
