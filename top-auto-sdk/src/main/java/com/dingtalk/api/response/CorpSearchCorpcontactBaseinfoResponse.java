 ...
 * @since 1.0, null
 */
public class CorpSearchCorpcontactBaseinfoResponse extends DingTalkResponse {

	private static final long serialVersionUID = 4378792613856728317L;
	...
	public static class GroupContactResult extends TaobaoObject {
		private static final long serialVersionUID = 4516719423488487242L;
		/**
		 * aliTmpDept
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 4177765943795597166L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 2814725625239259185L;
		/**
		 * dingOpenErrcode
		 */
