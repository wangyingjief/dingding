 ...
 * @since 1.0, null
 */
public class OapiProcessinstanceGetResponse extends DingTalkResponse {

	private static final long serialVersionUID = 5857961859123778172L;
	...
	public static class FormComponentValueVo extends TaobaoObject {
		private static final long serialVersionUID = 3275782357443922316L;
		/**
		 * 标签扩展值
		 */
		@ApiField("ext_value")
	...
	public static class OperationRecordsVo extends TaobaoObject {
		private static final long serialVersionUID = 5243967117468783196L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class TaskTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4744315863833342537L;
		/**
		 * 开始时间
		 */
	...
	public static class ProcessInstanceTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4251883343265515925L;
		/**
		 * 审批人
		 */
