 ...
 * @since 1.0, null
 */
public class OapiAttendanceGetAttendUpdateDataResponse extends DingTalkResponse {

	private static final long serialVersionUID = 8691349163244838295L;
	...
	public static class AtAttendanceResultForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4821464943377865553L;
		/**
		 * 打卡类型 上班还是下班
		 */
		@ApiField("check_type")
	...
	public static class AtApproveForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4424614658996736782L;
		/**
		 * 审批单开始时间
		 */
		@ApiField("begin_time")
	...
	public static class AtAttendanceRecordForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 7835217225653335785L;
		/**
		 * 基本定位精度
		 */
	...
	public static class AtCheckInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 7736267181766852434L;
		/**
		 * 审批单列表
		 */
