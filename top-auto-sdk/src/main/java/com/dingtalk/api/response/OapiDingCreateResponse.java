 ...
 * @since 1.0, null
 */
public class OapiDingCreateResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3382668372979542764L;
	...
	public static class CorpDingCreateResult extends TaobaoObject {
		private static final long serialVersionUID = 1214676112221227339L;
		/**
		 * invalidUser
		 */
