...
public class SmartworkAttendsGetusergroupResponse extends DingTalkResponse {
	...
	private static final long serialVersionUID = 4184269395253686441L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 3878174917477289736L;
		/**
		 * 打卡时间跨几天
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 7687486956447532861L;
		/**
		 * 班次中上下班详情列表
		 */
		@ApiListField("times")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 1131345847963578294L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 6199528595541724718L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupFullForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7742288156863627488L;
		/**
		 * 考勤组中的班次列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 2276664829424336181L;
		/**
		 * dingOpenErrcode
		 */
