 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripCostCenterQueryResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3676729442537539132L;
	...
	public static class OpenOrgEntityDo extends TaobaoObject {
		private static final long serialVersionUID = 2469673219551538663L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenCostCenterQueryRs extends TaobaoObject {
		private static final long serialVersionUID = 5112888285833164586L;
		/**
		 * 绑定支付宝账号
		 */
		@ApiField("alipay_no")
