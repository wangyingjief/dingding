 ...
 * @since 1.0, null
 */
public class OapiAttendanceGetusergroupResponse extends DingTalkResponse {

	private static final long serialVersionUID = 8664818271933619812L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 8272571913247965379L;
		/**
		 * 打卡时间跨几天
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 1115554275326375897L;
		/**
		 * 班次中上下班详情列表
		 */
		@ApiListField("times")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 6191156714244735632L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 4131884492649972951L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupFullForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 8723757635343265545L;
		/**
		 * 考勤组中的班次列表
		 */
