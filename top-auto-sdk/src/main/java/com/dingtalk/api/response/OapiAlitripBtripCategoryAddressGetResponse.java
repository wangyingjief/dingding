 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripCategoryAddressGetResponse extends DingTalkResponse {

	private static final long serialVersionUID = 5488854753372293719L;
	...
	public static class OpenJumpInfoRs extends TaobaoObject {
		private static final long serialVersionUID = 3735118199542985834L;
		/**
		 * 跳转url
		 */
		@ApiField("url")
