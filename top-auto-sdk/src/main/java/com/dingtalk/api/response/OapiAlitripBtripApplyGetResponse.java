 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripApplyGetResponse extends DingTalkResponse {

	private static final long serialVersionUID = 8649459594588461695L;
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 7434929949564116592L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 4512414533669524354L;
		/**
		 * 出行人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenApproverInfo extends TaobaoObject {
		private static final long serialVersionUID = 8497488653722391761L;
		/**
		 * 审批意见
		 */
		@ApiField("note")
	...
	public static class OpenApplyRs extends TaobaoObject {
		private static final long serialVersionUID = 8126346615638527273L;
		/**
		 * 商旅审批展示id
		 */
