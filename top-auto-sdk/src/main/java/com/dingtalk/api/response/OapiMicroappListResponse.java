 ...
 * @since 1.0, null
 */
public class OapiMicroappListResponse extends DingTalkResponse {

	private static final long serialVersionUID = 8281437113518793256L;
	...
	public static class Applist extends TaobaoObject {
		private static final long serialVersionUID = 5512246271482428322L;
		/**
		 * 微应用实例化id
		 */
		@ApiField("agentId")
