 ...
 * @since 1.0, null
 */
public class OapiBlackboardListtoptenResponse extends DingTalkResponse {

	private static final long serialVersionUID = 1615334169439395373L;
	...
	public static class OapiBlackboardVo extends TaobaoObject {
		private static final long serialVersionUID = 6649177537718623925L;
		/**
		 * 创建时间
		 */
		@ApiField("gmt_create")
