 ...
 * @since 1.0, null
 */
public class OapiImpaasUserGetlogintokenResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3428661259748283178L;
	...
	public static class GetLoginTokenResp extends TaobaoObject {
		private static final long serialVersionUID = 4194451695524924864L;
		/**
		 * expire
		 */
		@ApiField("expire")
