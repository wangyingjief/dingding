 ...
 * @since 1.0, null
 */
public class OapiMicroappListByUseridResponse extends DingTalkResponse {

	private static final long serialVersionUID = 5518225336346155659L;
	...
	public static class Applist extends TaobaoObject {
		private static final long serialVersionUID = 7711363647961867894L;
		/**
		 * 微应用实例化id
		 */
		@ApiField("agentId")
