 ...
 * @since 1.0, null
 */
public class OapiAttendanceListscheduleResponse extends DingTalkResponse {

	private static final long serialVersionUID = 5563851911867829351L;
	...
	public static class AtScheduleForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7269342368787666394L;
		/**
	...
	public static class AtScheduleListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2377289697388347642L;
		/**
		 * 分页用，表示是否还有下一页
		 */
		@ApiField("has_more")
