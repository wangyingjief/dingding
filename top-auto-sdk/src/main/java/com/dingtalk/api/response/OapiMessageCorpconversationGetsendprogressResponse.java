 ...
 * @since 1.0, null
 */
public class OapiMessageCorpconversationGetsendprogressResponse extends DingTalkResponse {

	private static final long serialVersionUID = 1552523765258588861L;
	...
	public static class AsyncSendProgress extends TaobaoObject {
		private static final long serialVersionUID = 5464377143185184935L;
		/**
		 * 取值 0-100，表示处理的百分比
		 */
