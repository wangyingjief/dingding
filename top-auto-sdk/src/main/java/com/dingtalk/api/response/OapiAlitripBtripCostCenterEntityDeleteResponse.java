 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripCostCenterEntityDeleteResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3735264754539961315L;
	...
	public static class OpenCostCenterDeleteEntityRs extends TaobaoObject {
		private static final long serialVersionUID = 2557779327189626888L;
		/**
		 * 删除的人员信息条数
		 */
		@ApiField("remove_num")
