 ...
 * @since 1.0, null
 */
public class OapiAuthScopesResponse extends DingTalkResponse {

	private static final long serialVersionUID = 8732619761214862676L;
	...
	public static class AuthOrgScopes extends TaobaoObject {
		private static final long serialVersionUID = 4738577893754148511L;
		/**
		 * 企业授权的部门id列表
		 */
