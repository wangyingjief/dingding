 ...
 * @since 1.0, null
 */
public class OapiServiceGetAuthInfoResponse extends DingTalkResponse {

	private static final long serialVersionUID = 2332794146417279763L;
	...
	public static class Agent extends TaobaoObject {
		private static final long serialVersionUID = 2374283342123917726L;
		/**
		 * admin_list
		 */
	...
	public static class AuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 1135554212425463164L;
		/**
		 * agent
		 */
		@ApiListField("agent")
	...
	public static class AuthUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 4273581341215556419L;
		/**
		 * userId
		 */
		@ApiField("userId")
	...
	public static class AuthCorpInfo extends TaobaoObject {
		private static final long serialVersionUID = 8747818668812821881L;
		/**
		 * auth_channel
		 */
	...
	public static class Channelagent extends TaobaoObject {
		private static final long serialVersionUID = 6517526686582812483L;
		/**
		 * agent_name
		 */
		@ApiField("agent_name")
	...
	public static class ChannelAuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 5473448867929942271L;
		/**
		 * channelAgent
		 */
