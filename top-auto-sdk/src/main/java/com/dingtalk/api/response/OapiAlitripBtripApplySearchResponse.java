 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripApplySearchResponse extends DingTalkResponse {

	private static final long serialVersionUID = 5597391773159269417L;
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 1841195336329956172L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 5359627646877472929L;
		/**
		 * 用户名称
		 */
		@ApiField("user_name")
	...
	public static class OpenApproverInfo extends TaobaoObject {
		private static final long serialVersionUID = 8524315948962316919L;
		/**
		 * 审批意见
		 */
		@ApiField("note")
	...
	public static class OpenApplyRs extends TaobaoObject {
		private static final long serialVersionUID = 5339395768181525353L;
		/**
		 * 商旅审批展示id
		 */
