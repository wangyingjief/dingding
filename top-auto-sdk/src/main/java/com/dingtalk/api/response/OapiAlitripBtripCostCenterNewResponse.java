 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripCostCenterNewResponse extends DingTalkResponse {

	private static final long serialVersionUID = 5242255947256727123L;
	...
	public static class OpenCostCenterSaveRs extends TaobaoObject {
		private static final long serialVersionUID = 3375589591194597357L;
		/**
		 * 商旅横版中心id
		 */
		@ApiField("id")
