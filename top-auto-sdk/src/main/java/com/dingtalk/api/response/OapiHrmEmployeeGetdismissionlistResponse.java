 ...
 * @since 1.0, null
 */
public class OapiHrmEmployeeGetdismissionlistResponse extends DingTalkResponse {

	private static final long serialVersionUID = 5643833874944465396L;
	...
	public static class HrmApiDismissionModel extends TaobaoObject {
		private static final long serialVersionUID = 6327836113313413269L;
		/**
		 * 入职时间
		 */
	...
	public static class HrmApiPage extends TaobaoObject {
		private static final long serialVersionUID = 5855998747883299218L;
		/**
		 * 当前页
		 */
		@ApiField("current")
