 ...
 * @since 1.0, null
 */
public class OapiRoleGetrolegroupResponse extends DingTalkResponse {

	private static final long serialVersionUID = 2111272131197375456L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 7483125755486644229L;
		/**
		 * 角色id
		 */
		@ApiField("role_id")
	...
	public static class OpenRoleGroup extends TaobaoObject {
		private static final long serialVersionUID = 3348336697165457241L;
		/**
		 * 角色组名
		 */
		@ApiField("group_name")
