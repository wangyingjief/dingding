 ...
 * @since 1.0, null
 */
public class OapiExtcontactListlabelgroupsResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3282292812569363394L;
	...
	public static class OpenLabel extends TaobaoObject {
		private static final long serialVersionUID = 3243212185964269379L;
		/**
		 * 标签id
		 */
		@ApiField("id")
	...
	public static class OpenLabelGroup extends TaobaoObject {
		private static final long serialVersionUID = 3448854745267714546L;
		/**
		 * 标签组颜色
		 */
		@ApiField("color")
