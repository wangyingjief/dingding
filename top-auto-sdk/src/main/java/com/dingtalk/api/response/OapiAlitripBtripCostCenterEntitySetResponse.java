 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripCostCenterEntitySetResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3383731494456537238L;
	...
	public static class OpenCostCenterSetEntityRs extends TaobaoObject {
		private static final long serialVersionUID = 3882182654833791641L;
		/**
		 * 增加的人员信息条数
		 */
		@ApiField("add_num")
