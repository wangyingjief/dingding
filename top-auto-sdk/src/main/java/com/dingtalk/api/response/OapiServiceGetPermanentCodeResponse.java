 ...
 * @since 1.0, null
 */
public class OapiServiceGetPermanentCodeResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3514981961578261686L;
	...
	public static class AuthCorpInfo extends TaobaoObject {
		private static final long serialVersionUID = 4242633846699596842L;
		/**
		 * corp_name
		 */
		@ApiField("corp_name")
