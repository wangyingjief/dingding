 ...
 * @since 1.0, null
 */
public class OapiAlitripBtripTrainOrderSearchResponse extends DingTalkResponse {

	private static final long serialVersionUID = 1199289481943534873L;
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 1455346657855153196L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 8333751517923962393L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 7336776771471663146L;
		/**
		 * 消费类型
		 */
		@ApiField("category")
	...
	public static class OpenTrainOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 2818514789835565131L;
		/**
		 * 商旅审批单id
		 */
		@ApiField("apply_id")
