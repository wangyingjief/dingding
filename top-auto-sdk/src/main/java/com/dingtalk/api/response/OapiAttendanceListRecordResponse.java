 ...
 * @since 1.0, null
 */
public class OapiAttendanceListRecordResponse extends DingTalkResponse {

	private static final long serialVersionUID = 5171899188971735168L;
	...
	public static class Recordresult extends TaobaoObject {
		private static final long serialVersionUID = 3298783996934881335L;
		/**
		 * approveId
		 */
		@ApiField("approveId")
