 ...
 */
public class CorpDingTaskCreateRequest extends BaseDingTalkRequest<CorpDingTaskCreateResponse> {
	...
	* 任务对外接口
	...
	public static class TaskSendVo extends TaobaoObject {
		private static final long serialVersionUID = 8346559933348833189L;
		/**
		 * 任务内容
		 */
		@ApiField("content")
