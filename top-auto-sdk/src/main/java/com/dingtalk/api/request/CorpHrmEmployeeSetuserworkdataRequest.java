 ...
 */
public class CorpHrmEmployeeSetuserworkdataRequest extends BaseDingTalkRequest<CorpHrmEmployeeSetuserworkdataResponse> {
	...
	* 操作人userid，必须是拥有被操作人操作权限的管理员userid
	...
	public static class HrmApiUserDataModel extends TaobaoObject {
		private static final long serialVersionUID = 5188985714718491328L;
		/**
		 * 数据项描述信息
		 */
		@ApiField("data_desc")
