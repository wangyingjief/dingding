 ...
 */
public class OapiSmartdeviceVisitorAddvisitorRequest extends BaseDingTalkRequest<OapiSmartdeviceVisitorAddvisitorResponse> {
	...
	* 访客预约模型
	...
	public static class DidoVisitorVo extends TaobaoObject {
		private static final long serialVersionUID = 4277766282398439451L;
		/**
		 * 预约开始时间
		 */
