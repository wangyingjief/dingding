 ...
 */
public class OapiAlitripBtripHotelOrderSearchRequest extends BaseDingTalkRequest<OapiAlitripBtripHotelOrderSearchResponse> {
	...
	* rq
	...
	public static class OpenSearchRq extends TaobaoObject {
		private static final long serialVersionUID = 2692823329611966889L;
		/**
		 * 商旅审批单id
		 */
		@ApiField("apply_id")
