 ...
 */
public class OapiAlitripBtripCostCenterQueryRequest extends BaseDingTalkRequest<OapiAlitripBtripCostCenterQueryResponse> {
	...
	* 请求对象
	...
	public static class OpenCostCenterQueryRq extends TaobaoObject {
		private static final long serialVersionUID = 6887228375948544555L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
