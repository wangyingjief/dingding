 ...
 */
public class OapiDingTaskCreateRequest extends BaseDingTalkRequest<OapiDingTaskCreateResponse> {
	...
	* 任务对外接口
	...
	public static class TaskSendVo extends TaobaoObject {
		private static final long serialVersionUID = 2381944319554589357L;
		/**
		 * 任务内容
		 */
		@ApiField("content")
