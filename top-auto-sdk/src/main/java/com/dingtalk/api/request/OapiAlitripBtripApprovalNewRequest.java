 ...
 */
public class OapiAlitripBtripApprovalNewRequest extends BaseDingTalkRequest<OapiAlitripBtripApprovalNewResponse> {
	...
	* 请求对象
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 2151188222422778876L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 2591358998957799991L;
		/**
		 * 出行人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenApiNewApplyRq extends TaobaoObject {
		private static final long serialVersionUID = 2148127895322911247L;
		/**
		 * 企业名称
		 */
		@ApiField("corp_name")
