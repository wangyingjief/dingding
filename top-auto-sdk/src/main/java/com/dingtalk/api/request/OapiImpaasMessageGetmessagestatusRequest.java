 ...
 */
public class OapiImpaasMessageGetmessagestatusRequest extends BaseDingTalkRequest<OapiImpaasMessageGetmessagestatusResponse> {
	...
	* 根据异步发送时返回的taskid获取消息
	...
	public static class AccountInfo extends TaobaoObject {
		private static final long serialVersionUID = 3164141259458551151L;
		/**
		 * 账号的通道
		 */
		@ApiField("channel")
	...
	public static class GetMessageStatusRequest extends TaobaoObject {
		private static final long serialVersionUID = 7556344957114641914L;
		/**
		 * 账号信息
		 */
		@ApiField("senderid")
