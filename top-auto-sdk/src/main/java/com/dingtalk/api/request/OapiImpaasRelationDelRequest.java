 ...
 */
public class OapiImpaasRelationDelRequest extends BaseDingTalkRequest<OapiImpaasRelationDelResponse> {
	...
	* 关系
	...
	public static class DelRelationReq extends TaobaoObject {
		private static final long serialVersionUID = 6132878335728561646L;
		/**
		 * 接受者的im的openid
		 */
