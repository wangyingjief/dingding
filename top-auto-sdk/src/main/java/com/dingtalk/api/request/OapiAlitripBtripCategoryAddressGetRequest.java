 ...
 */
public class OapiAlitripBtripCategoryAddressGetRequest extends BaseDingTalkRequest<OapiAlitripBtripCategoryAddressGetResponse> {
	...
	* 请求对象
	...
	public static class OpenJumpInfoRq extends TaobaoObject {
		private static final long serialVersionUID = 6581814783422441295L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
