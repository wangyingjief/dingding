 ...
 */
public class OapiAlitripBtripCostCenterEntityDeleteRequest extends BaseDingTalkRequest<OapiAlitripBtripCostCenterEntityDeleteResponse> {
	...
	* 请求对象
	...
	public static class OpenOrgEntityDo extends TaobaoObject {
		private static final long serialVersionUID = 8688746511694961759L;
		/**
		 * 员工/部门/角色id
		 */
		@ApiField("entity_id")
	...
	public static class OpenCostCenterDeleteEntityRq extends TaobaoObject {
		private static final long serialVersionUID = 4289716166316885498L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
