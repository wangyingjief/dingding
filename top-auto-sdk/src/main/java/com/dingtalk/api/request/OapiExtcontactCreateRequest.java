 ...
 */
public class OapiExtcontactCreateRequest extends BaseDingTalkRequest<OapiExtcontactCreateResponse> {
	...
	* 外部联系人信息
	...
	public static class OpenExtContact extends TaobaoObject {
		private static final long serialVersionUID = 5556523922768938827L;
		/**
		 * 地址
		 */
		@ApiField("address")
