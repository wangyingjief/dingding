 ...
 */
public class OapiAlitripBtripCostCenterModifyRequest extends BaseDingTalkRequest<OapiAlitripBtripCostCenterModifyResponse> {
	...
	* 请求对象
	...
	public static class OpenCostCenterModifyRq extends TaobaoObject {
		private static final long serialVersionUID = 1383183792822283511L;
		/**
		 * 绑定支付宝账号
		 */
		@ApiField("alipay_no")
