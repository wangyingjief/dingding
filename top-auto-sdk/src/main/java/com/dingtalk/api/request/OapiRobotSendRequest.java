 ...
 */
public class OapiRobotSendRequest extends BaseDingTalkRequest<OapiRobotSendResponse> {
	...
	* text类型
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 1193225588533475242L;
		/**
		 * text类型
		 */
		@ApiField("content")
	...
	public static class At extends TaobaoObject {
		private static final long serialVersionUID = 6154727994686689612L;
		/**
		 * 被@人的手机号
		 */
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 8658184462277911685L;
		/**
		 * 点击消息跳转的URL
		 */
		@ApiField("messageUrl")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 5566871148599653579L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Btns extends TaobaoObject {
		private static final long serialVersionUID = 6238656447456235358L;
		/**
		 * 按钮方案，
		 */
		@ApiField("actionURL")
	...
	public static class Actioncard extends TaobaoObject {
		private static final long serialVersionUID = 5267732962996972284L;
		/**
		 * 0-按钮竖直排列，1-按钮横向排列
		 */
	...
	public static class Links extends TaobaoObject {
		private static final long serialVersionUID = 5862318591531963436L;
		/**
		 * 点击单条信息到跳转链接
		 */
		@ApiField("messageURL")
	...
	public static class Feedcard extends TaobaoObject {
		private static final long serialVersionUID = 1349364795798639814L;
		/**
		 * links
		 */
		@ApiListField("links")
