 ...
 */
public class OapiExtcontactUpdateRequest extends BaseDingTalkRequest<OapiExtcontactUpdateResponse> {
	...
	* 外部联系人信息
	...
	public static class OpenExtContact extends TaobaoObject {
		private static final long serialVersionUID = 5895754451744778212L;
		/**
		 * 地址
		 */
		@ApiField("address")
