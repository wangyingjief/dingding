 ...
 */
public class OapiAlitripBtripApplyGetRequest extends BaseDingTalkRequest<OapiAlitripBtripApplyGetResponse> {
	...
	* 请求对象
	...
	public static class OpenSearchRq extends TaobaoObject {
		private static final long serialVersionUID = 2794747886366596335L;
		/**
		 * 阿里商旅审批单id
		 */
		@ApiField("apply_id")
