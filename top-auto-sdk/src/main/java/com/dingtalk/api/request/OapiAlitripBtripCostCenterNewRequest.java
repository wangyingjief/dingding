 ...
 */
public class OapiAlitripBtripCostCenterNewRequest extends BaseDingTalkRequest<OapiAlitripBtripCostCenterNewResponse> {
	...
	* 请求对象
	...
	public static class OpenCostCenterSaveRq extends TaobaoObject {
		private static final long serialVersionUID = 2418988358587888976L;
		/**
		 * 绑定支付宝账号
		 */
		@ApiField("alipay_no")
