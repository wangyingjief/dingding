 ...
 */
public class OapiAlitripBtripApplySearchRequest extends BaseDingTalkRequest<OapiAlitripBtripApplySearchResponse> {
	...
	* 请求对象
	...
	public static class OpenSearchRq extends TaobaoObject {
		private static final long serialVersionUID = 3594282669436838411L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
