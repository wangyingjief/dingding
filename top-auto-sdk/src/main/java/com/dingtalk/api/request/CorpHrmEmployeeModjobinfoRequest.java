 ...
 */
public class CorpHrmEmployeeModjobinfoRequest extends BaseDingTalkRequest<CorpHrmEmployeeModjobinfoResponse> {
	...
	* 操作人userid，必须是拥有被操作人操作权限的管理员userid
	...
	public static class HrmApiJobModel extends TaobaoObject {
		private static final long serialVersionUID = 1754561418425686313L;
		/**
		 * 生日日期
		 */
		@ApiField("birth_time")
