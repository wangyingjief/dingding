 ...
 */
public class OapiAlitripBtripTrainOrderSearchRequest extends BaseDingTalkRequest<OapiAlitripBtripTrainOrderSearchResponse> {
	...
	* 请求对象
	...
	public static class OpenSearchRq extends TaobaoObject {
		private static final long serialVersionUID = 7794433121363329756L;
		/**
		 * 商旅审批单id
		 */
		@ApiField("apply_id")
