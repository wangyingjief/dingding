 ...
 */
public class OapiSmartdeviceVisitorEditvisitorRequest extends BaseDingTalkRequest<OapiSmartdeviceVisitorEditvisitorResponse> {
	...
	* 预约数据
	...
	public static class DidoVisitorVo extends TaobaoObject {
		private static final long serialVersionUID = 5263983842835896649L;
		/**
		 * 预约开始时间
		 */
